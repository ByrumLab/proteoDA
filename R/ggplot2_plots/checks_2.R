...
#'   The function will give an error if the {.arg label_column} is not a column
#'   in {.arg metadata}, label values have missing values, blanks, or are not
#'   unique. A warning is displayed if the label values do not follow R syntax
#'   rules.
#' @param verbose logical. Should the values of the label_colum be checked for
#'   character length? Default: False
#'
...
#' @keywords internal
#'
#' @return If all checks pass the function returns the {.arg label_column}
#'   column name.
#'
#' @examples
#' \dontrun{
...
#' @keywords internal
#'
#' @return If all checks pass the function returns the {.arg grouping_column}
#'   column name.
#'
#' @examples
#'
