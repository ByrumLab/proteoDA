...
qc_violin_plot5 <- function (data,
   ...
   testthat::expect_is(object = data, class = c("matrix","data.frame"))
   testthat::expect_is(object = groups, class = c("numeric","integer", "character","factor","NULL"))
   testthat::expect_is(object = sample_labels, class = c("character","NULL"))
   testthat::expect_is(object = title, class = c("numeric","integer","character","NULL"))
   testthat::expect_is(object = text.sizes, class = c("numeric","integer"))
