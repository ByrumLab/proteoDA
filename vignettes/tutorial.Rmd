---
title: "Tutorial: proteomics analysis using proteoDAv1.0"
output:
  html_document:
    rmarkdown::html_vignette
vignette: >
  %\VignetteEncoding{UTF-8}
  %\VignetteIndexEntry{Tutorial: proteomics analysis using proteoDAv1.0}
...
```{r, message = F}
no_intercept <- add_contrasts(no_intercept,
                              contrasts_file = system.file("extdata/contrasts.csv", package = "proteoDAstjude"))
```
